      ...
      <div className="mx-auto grid w-full max-w-6xl gap-10 md:grid-cols-2 md:items-center">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }}>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://wa.me/918356810826?text=Hello%20D.P.%20Jewels%2C%20I%20am%20interested%20in%20a%20diamond%20enquiry." className="rounded-full border border-white/20 px-6 py-3 text-sm tracking-[0.08em]">WhatsApp</a>
